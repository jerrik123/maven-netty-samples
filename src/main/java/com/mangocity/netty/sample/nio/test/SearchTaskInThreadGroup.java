...
//用到了线程组
public class SearchTaskInThreadGroup implements Runnable {

	public SearchTaskInThreadGroup(Result result) {
		this.result = result;
	}
	...
	public static void main(String[] args) {
		...
		SearchTaskInThreadGroup searchTask = new SearchTaskInThreadGroup(result);
		for (int i = 0; i < 5; i++) {
